...
[create a proposal](https://github.com/laminas/laminas-migration/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git://github.com/laminas/laminas-migration.git
...
2. Fork the repository (https://github.com/laminas/laminas-migration)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/laminas-migration.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/laminas-migration.git
